...
def run_quick_coverage(suite: str, test: str, source_file: str) -> dict:
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        return {
            ...
            "after": after,
            "delta": delta,
            "warning": "gcda 文件已被删除，需重新运行完整测试以恢复完整覆盖率数据",
        }
...
def main():
    ...
    result = run_quick_coverage(args.suite, args.test, args.file)
